...
export function adaptProject(p) {
  ...
  return {
    ...
    engineers: Array.isArray(p.engineers) ? p.engineers.map((e) => e.name || e) : [],
    engineerIds: Array.isArray(p.engineers) ? p.engineers.map((e) => e.id || e) : [],
...
export function adaptMaterial(m) {
  ...
  return {
    ...
    confirmedBy: typeof m.confirmedBy === "object" ? m.confirmedBy?.name : m.confirmedBy,
    requestedBy: typeof m.requestedBy === "object" ? m.requestedBy?.name : m.requestedBy,
    providedBy: typeof m.providedBy === "object" ? m.providedBy?.name : m.providedBy,
    acknowledgedBy: typeof m.acknowledgedBy === "object" ? m.acknowledgedBy?.name : m.acknowledgedBy,
